@extends('dark_deshbord.top_design.main')
							...
							<ul class="header-actions">
										...
										<div class="customScroll">
											<ul class="header-notifications">
												<li>
													<a href="#">
														<div class="user-img online">
															<img src="{{url('dark_deshbord_style/img/user6.png')}}" alt="User">
														</div>
														<div class="details">
												...
												<li>
													<a href="#">
														<div class="user-img busy">
															<img src="{{url('dark_deshbord_style/img/user10.png')}}" alt="User">
														</div>
														<div class="details">
												...
												<li>
													<a href="#">
														<div class="user-img away">
															<img src="{{url('dark_deshbord_style/img/user21.png')}}" alt="User">
														</div>
														<div class="details">
												...
												<li>
													<a href="#">
														<div class="user-img busy">
															<img src="{{url('dark_deshbord_style/img/user15.png')}}" alt="User">
														</div>
														<div class="details">
												...
												<li>
													<a href="#">
														<div class="user-img online">
															<img src="{{url('dark_deshbord_style/img/user5.png')}}" alt="User">
														</div>
														<div class="details">
								...
								<li class="dropdown">
									<a href="#" id="userSettings" class="user-settings" data-toggle="dropdown" aria-haspopup="true">
										<span class="avatar">
											<img src="{{url('dark_deshbord_style/img/user5.png')}}" alt="User Avatar">
											...
											<table class="table products-table">
												...
												<tbody>
													<tr>
														...
														<td>20/11/2020</td>
														<td>
															<img class="user" src="{{url('dark_deshbord_style/img/products/bag.jpeg')}}" alt="Product Image">
														</td>
														<td>
													...
													<tr>
														...
														<td>23/11/2020</td>												
														<td>
															<img class="user" src="{{url('dark_deshbord_style/img/products/toy.jpeg')}}" alt="Product Image">
														</td>
														<td>
													...
													<tr>
														...
														<td>26/11/2020</td>												
														<td>
															<img class="user" src="{{url('dark_deshbord_style/img/products/pencils.jpeg')}}" alt="Product Image">
														</td>
														<td>
													...
													<tr>
														...
														<td>25/11/2020</td>
														<td>
															<img class="user" src="{{url('dark_deshbord_style/img/products/camera.jpeg')}}" alt="Product Image">
														</td>
														<td>
